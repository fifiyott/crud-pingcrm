...
// CRUD Users
Route::get('/crudusers', [CrudusersController::class, 'index'])
    ->name('user.index'); // menampilkan data secara keseluruhan dari database secara keseluruhan
Route::post('crudusers', [CrudusersController::class, 'store']); //mengirimkan data ke server untuk dikelola
