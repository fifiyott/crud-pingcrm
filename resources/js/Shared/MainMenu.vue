<template>
  <div>
    ...
    <div class="mb-4">
      <Link class="group flex items-center py-3" href="/crudusers">
        <icon name="users" class="mr-2 w-4 h-4" :class="isUrl('crudusers') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
        <div :class="isUrl('crudusers') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">CRUD Users</div>
      </Link>
    </div>
    <div class="mb-4">
